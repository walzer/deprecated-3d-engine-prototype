...
{
    C3DStaticObj* sm = C3DStaticObj::create("back");
    
    sm->loadFromFile("scene/ChangJing_DiMian/ChangJing_DiMian.ckb");
    
    sm->setMaterial("scene/ChangJing_DiMian/ChangJing_DiMian.material");
    sm->translate(0, 0, 0);
    //sm->rotateX(0.8f);
    sm->scale(1.5f, 1.5f, 1.5f);
    sm->setPosition(0.0f, 0.0f, -30.f);
    _scene->addChild(sm);

    C3DSprite* shuicao = C3DSprite::create("hua");
    shuicao->loadFromFile("2.5D/plant/hua_01/hua_01.ckb",true);
    ...
    particle->load("particles/beijingpaopao01.particle");
 ...
 //   particle->scale(0.3f, 0.30f, 0.3f); 
    ...
    particle->load("particles/hua01_xinguang01.particle");
    ...
    particle->load("particles/ChenAi.particle");
    _scene->addChild(particle);
    
    particle = C3DParticleSystem::create("suidao");
    particle->load("particles/shikongsuidao02.particle");
	...
	_lighting = C3DLineRender::create( "sceneEffect/lighting.material" );
