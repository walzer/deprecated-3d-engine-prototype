...
void FullDemoLayer::createStaticModel()
{
	...
	if(sm != NULL)
	{
		sm->loadFromFile("demo/scene/scene.ckb");	
		sm->translate(0, -1, 0);
		sm->scale(1, 1, 1);
		sm->showAABB(true);
		_scene->addChild(sm);	
...
void FullDemoLayer::createParticleEffect()
{
	...
	if(ps!=NULL)
	{
		ps->load("particles/fire.particle");
		ps->setScale(1.2f);
		_scene->addChild(ps);
	...
	if(ps2!=NULL)
	{
		ps2->load("particles/fire01.particle");
		ps2->setScale(1.0f);
		_scene->addChild(ps2);
	...
	particle->load("particles/nengliangtai.particle");
...
{	
	...
	entity = static_cast<cocos3d::C3DSprite*>(C3DSpriteManager::getInstance()->getResource("demo/warrior/warrior.ckb"));
	if(entity != NULL)
	{	
		...
		_mainPlayer->addPart("body","body","demo/warrior/body.material");			
...
{ 
	...
	entity = static_cast<cocos3d::C3DSprite*>(C3DSpriteManager::getInstance()->getResource("demo/guai/guai.ckb"));
	...
	{		
      //  entity->loadFromFile("demo/guai/guai.ckb",true);			
		...
		for (int i = 0; i < 5; i++)
		{
			...
			//...
			C3DSprite* newEntity = static_cast<cocos3d::C3DSprite*>(C3DSpriteManager::getInstance()->getResource("demo/guai/guai.ckb"));
			//...
...
{	
	...
	if(entity != NULL)
	{
		...
		entity->loadFromFile("objects/test.ckb");
		...
		npc->addPart("cap","Girl_Maozi_01","objects/Girl_Maozi_01.material");	
		npc->addPart("hair","Girl_Toufa_01","objects/Girl_Toufa_01.material");	
		npc->addPart("hair","Girl_Toufa_02","objects/Girl_Toufa_02.material");	
		npc->addPart("face","Girl_Lian_01","objects/Girl_Lian_01.material");	
		npc->addPart("glasses","Girl_Yanjing_01","objects/Girl_Yanjing_01.material");	
		npc->addPart("shangshen","Girl_Shangshen_01","objects/Girl_Shangshen_01.material");	
		npc->addPart("shangshen","Girl_Shangshen_01","objects/Girl_Shangshen_03.material");	
		npc->addPart("shangshen","Girl_Shangshen_02","objects/Girl_Shangshen_02.material");	
		npc->addPart("hand","Girl_Shou_01","objects/Girl_Shou_01.material");	
		npc->addPart("xiashen","Girl_Xiashen_01","objects/Girl_Xiashen_01.material");	
		npc->addPart("xiashen","Girl_Xiashen_02","objects/Girl_Xiashen_02.material");	
		npc->addPart("shoes","Girl_Xie_01","objects/Girl_Xie_01.material");	
		npc->addPart("shoes","Girl_Xie_02","objects/Girl_Xie_02.material");	
...
void FullDemoLayer::createAnimLight()
{
	...
	C3DAnimatedLight* animLight = C3DAnimatedLight::create(C3DVector3(1.0f, 0.0f, 0.0f), "sceneEffect/caustics.png");
