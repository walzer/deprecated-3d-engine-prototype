...
bool FullDemoUILayer::init()
{
	...
	pItemNearAttack->setPosition(		ccp(VisibleRect::left().x+50+70*0, VisibleRect::bottom().y+50 ) );
	pItemFarAttack->setPosition(		ccp(VisibleRect::left().x+50+70*1, VisibleRect::bottom().y+50 ) );
	pItemLightingSkill->setPosition(	ccp(VisibleRect::left().x+50+70*2, VisibleRect::bottom().y+50 ) );
	pItemShowMiniMap->setPosition(		ccp(VisibleRect::left().x+50+70*3, VisibleRect::bottom().y+50 ) );  
    pItemShowPerformance->setPosition(ccp(VisibleRect::left().x+90+70*4, VisibleRect::bottom().y+50 ));
