...
void ColorTestLayer::setUpScene()
{
    ...
    sm->loadFromFile("2.5D/plant/hua_01/hua_01.ckb",true);

    sm->addAnimationClip("all", 0 , 240, 0, 1.0f);			

   // sm->addPartConfig("body",false);		
   sm->setMaterial("body", "2.5D/plant/hua_01/hua_01.material");
   // sm->addPart("body", "body", "2.5D/plant/hua_01.material");		
