...
void ChangeClothesTestLayer::createLive()
{
	...
	if(entity != NULL)
	{
		...
		_actor->addPart("cap","Girl_Maozi_01","objects/Girl_Maozi_01.material");	
		_actor->addPart("hair","Girl_Toufa_01","objects/Girl_Toufa_01.material");	
		_actor->addPart("hair","Girl_Toufa_02","objects/Girl_Toufa_02.material");	
		_actor->addPart("face","Girl_Lian_01","objects/Girl_Lian_01.material");	
		_actor->addPart("glasses","Girl_Yanjing_01","objects/Girl_Yanjing_01.material");	
		_actor->addPart("shangshen","Girl_Shangshen_01","objects/Girl_Shangshen_01.material");	
		_actor->addPart("shangshen","Girl_Shangshen_01","objects/Girl_Shangshen_03.material");	
		_actor->addPart("shangshen","Girl_Shangshen_02","objects/Girl_Shangshen_02.material");	
		_actor->addPart("hand","Girl_Shou_01","objects/Girl_Shou_01.material");	
		_actor->addPart("xiashen","Girl_Xiashen_01","objects/Girl_Xiashen_01.material");	
		_actor->addPart("xiashen","Girl_Xiashen_02","objects/Girl_Xiashen_02.material");	
		_actor->addPart("shoes","Girl_Xie_01","objects/Girl_Xie_01.material");	
		_actor->addPart("shoes","Girl_Xie_02","objects/Girl_Xie_02.material");	
