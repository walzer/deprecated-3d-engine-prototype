...
void main()
{
    ...
    //reflectColor = reflectColor * u_reflectColor;
    //gl_FragColor = reflectColor;//gl_FragColor * 0.5 + reflectColor * 0.5;
    reflectColor.rgb = reflectColor.rgb * u_reflectColor.rgb;
    gl_FragColor.rgb = _ambientColor.rgb * 0.2 + _diffuseColor.rgb * 0.4 + reflectColor.rgb * 0.6;//mix(_diffuseColor, reflectColor.rgb, 0.7);//mix(gl_FragColor.rgb, reflectColor.rgb, 0.7);
